...
2. **To pay** - скільки реальних грошей витрачено (тільки для DigitalOcean)
3. **Threads** - кількість потоків на один процесс mhddos_proxy
4. Середні показники за 15 хвилин, 60 хвилин та увесь час роботи:
...
5. **Open health report** - клікабельна кнопка, що направить вас на [трекер цілей від IT Army](https://itarmy.com.ua/check/)
