...
2. **Balance/To pay** - скільки кредитів залишилось та скільки реальних грошей ви витратили (тільки для DigitalOcean)
...
5. **Total requests** - скільки реквестів в секунду відправляється на даний момент
6. **Total traffic** - загальна кількість трафіку що відправляється на усі цілі (чим більше, тим ефективніша атака)
7. **Top 5 targets by traffic** - цілей може бути сотня, але цікаво знати топ 5 за трафіком - на них йде найсильніша атака
